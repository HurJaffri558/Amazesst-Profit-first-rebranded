...
const faqs = [
    {
        ...
        answer: "Amazon brand owners doing around $100K per year who are stuck and want to scale to $500K and beyond. You should have at least one active SKU and be ready to invest in a proven system."
    },
    {
