            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
                    ...
                    <div className="p-8 rounded-[2rem] bg-primary/5 border border-primary/20 relative overflow-hidden">
                        <h4 className="font-bold text-white mb-4">Ready to Scale From $100K to $500K?</h4>
                        <p className="text-gray-400 text-xs mb-6">Book a free audit. We will review your account, find what is holding you back and show you exactly how we scale you to $500K.</p>
