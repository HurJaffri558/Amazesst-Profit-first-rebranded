...
const steps = [
    ...
    },
    {
        ...
        description: "We build a custom roadmap to take you from $100K to $500K based on what we found in the audit.",
        color: "bg-[#C6FF3D]"
    },
    {
        number: "04",
    ...
    },
    {
        ...
        description: "Weekly KPI reports every Monday. Monthly strategy reviews. Continuous optimization until we hit $500K.",
        color: "bg-primary"
    },
];
        ...
        <section className="py-24 px-6 relative overflow-hidden bg-zinc-950/30" id="process">
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-20">
                    ...
                    >
                        From First Call to $500K,<br /><span className="text-secondary italic">Here Is Exactly What Happens</span>
                    </motion.h2>
