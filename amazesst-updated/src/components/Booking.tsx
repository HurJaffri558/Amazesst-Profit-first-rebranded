        ...
        <section className="py-24 px-6 relative overflow-hidden" id="booking">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-16">
                    ...
                    >
                        Ready to Scale From <span className="text-primary italic">$100K to $500K?</span>
                    </motion.h2>
                    ...
                    >
                        Book a free audit. We will review your account, find what is holding you back and show you exactly how we scale you to $500K. No pressure, no pitch, just clarity.
                    </motion.p>
                </div>
