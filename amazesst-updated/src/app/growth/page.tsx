        ...
        <main className="min-h-screen bg-background selection:bg-primary/30">
                ...
                <div className="max-w-3xl mx-auto">
                    <div className="p-10 rounded-[2.5rem] bg-primary/5 border border-primary/20">
                        ...
                        <p className="text-gray-300 leading-relaxed">
                            You are a $100K Amazon seller who has the basics running but needs a full strategy to get to $500K. You want to improve your conversion rate, build a retention system, dominate your rankings and create bundles that increase your average order value and margins.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6">
                <div className="max-w-2xl mx-auto text-center">
                    <h2 className="text-4xl font-black text-white mb-6">Ready to Scale to $500K?</h2>
