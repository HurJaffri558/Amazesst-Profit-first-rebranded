                ...
                <div className="max-w-3xl mx-auto">
                    <div className="p-10 rounded-[2.5rem] bg-primary/5 border border-primary/20">
                        ...
                        <p className="text-gray-300 leading-relaxed">
                            You are an Amazon seller doing around $100K per year. You are stuck and frustrated and want to start scaling properly. You need your ads managed correctly and your listings optimized so your conversion rate improves and your ACOS comes down.
                        </p>
                    </div>
                </div>
            </section>
