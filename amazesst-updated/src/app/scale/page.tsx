        ...
        <main className="min-h-screen bg-background selection:bg-primary/30">
                ...
                <div className="max-w-3xl mx-auto">
                    <div className="p-10 rounded-[2.5rem] bg-primary/5 border border-primary/20">
                        ...
                        <p className="text-gray-300 leading-relaxed">
                            You are a serious $100K Amazon brand ready for aggressive growth to $500K and beyond. You want everything, from core PPC and listings all the way to advanced advertising through Amazon Marketing Cloud and a full funnel strategy. You are ready to go all in.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6">
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <p className="text-gray-400 mb-10">Book a free audit and we will show you exactly how the Scale Plan will take your brand to $500K and beyond.</p>
